    ...
    public void inform(ResourceLoader loader) throws IOException {
        ...
        try {
            ...
            for (String file : dicts) {
                // LMGREP: suuport loading from files
                File aFile = new File(file);
                dictionaries.add(new FileInputStream(aFile));
//                dictionaries.add(loader.openResource(file));
            }

            // LMGREP: support loading from files
            File aFile = new File(affixFile);
            affix = new FileInputStream(aFile);
